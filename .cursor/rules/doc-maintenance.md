---
description: Keep docs in lock-step with code. Auto-loads when editing agents/, skills/, cloud/, core/, or scripts/.
globs:
  - "agents/**"
  - "skills/**"
  - "cloud/**"
...
| `scripts/new_requirement.py`, `start_pr_session.py`, `phase_state.py`, `lifecycle.py`, `verify.py` | `docs/WORKFLOW.md` (lifecycle map) |
| `.github/workflows/claude-review.yml`, PR template, `check_pr_description.py` | `CONTRIBUTING.md` + `docs/contributing/review-bot.md` |
| `scripts/pr_cost_ledger.py`, `install-git-hooks.sh`, cost workflows | `docs/contributing/cost.md` + `RUNBOOK.md` |
