...
8b. **ADP payroll draft** (Issue #251, `BHAGA_ADP_PAYROLL_DRAFT=1` only): on the **Monday**
   nightly after a Sunday period-end, Start → fill NQCCTips/Bonus/Misc → Preview → **Delete**.
   Never Approve. Default env unset. `daily_refresh.period_end_payroll_draft_bounds`.
