-- 060_payroll_perk_labels.sql
-- Issue #251: perk_reason encodes id:dollars so the console can show one
-- Perks total plus N named chips (gym:20;phone:15). Replaces the 059 view.
-- Same view name — no new Grafana target.
--
