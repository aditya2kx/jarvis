-- 061_payroll_paid_hours.sql
-- Issue #251: Hours + Est. wages use ADP punch hours (adp_shifts), not
-- tip-eligible hours. Tip exemptions (training windows) drop tips only;
-- Regular pay still covers the clocked time (Dolce 2026-07-18 inventory
-- training: 1.52h paid, $24.70 wage_diff when the view used tip hours).
-- Tips stay t.our_calc from model_tip_alloc_period.
-- Replaces the 060 view. Same view name — no new Grafana target.
--
