-- 063_payroll_1to1_roster.sql
-- Issue #251: 1:1 people with ADP. Recent punchers (last 28 days before
-- period_start) with zero hours this window still appear at 0h (Juan
-- terminated; last Regular 29.95h on Jul 13–26, not this Aug 10–23 cycle).
-- Hours remain through yesterday CT (Aug 23 in-progress excluded).
-- Replaces the 062 view. Same view name — no new Grafana target.
--
