-- 064_payroll_adp_wage_rounding.sql
-- Issue #251: ADP Preview Gross uses half-up cents on hours×rate
-- (NUMERIC ROUND), not FLOAT64. 47.30×$15.25 = 721.325 → $721.33
-- (IEEE ROUND was $721.32, $0.01 off vs ADP). Same roster as 063.
-- Replaces the 063 view. Same view name — no new Grafana target.
--
