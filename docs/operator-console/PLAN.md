...
| 2026-07-12 | Home + Accounting (Issue #158) | Home renamed **Goal and Tracking**: net sales, PT labor %, total labor %, prep p95@8, Risky base count=0. Plaid Link + `/transactions/sync` ledger (migration 036) + `/accounting` (Square in / Plaid out, PFC interim). Custom categorization + QBO deferred to follow-up issues. |
