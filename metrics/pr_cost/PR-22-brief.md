...
PR #21 'fix(ci): auto-commit cost report to main on merge (ADMIN_PAT': $2.56 total (build $2.28 / review $0.29, 2 review runs)
...
## Cost gate reminder
Before your final push: `python3 scripts/pr_cost_ledger.py sync --pr 22`
Then: `git add metrics/pr_cost/ && git commit -m "chore(cost): sync PR #22 ledger"`
